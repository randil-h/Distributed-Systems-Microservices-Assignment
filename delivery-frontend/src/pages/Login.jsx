...
const Login = () => {
    ...
    const styles = {
        ...
        imageContainer: "w-1/2 bg-cover bg-center relative", // make it relative so text can be absolute centered
        image: "w-full h-full object-cover filter brightness-75 saturate-75", // reduce brightness and saturation
